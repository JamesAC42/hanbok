export const de = {
    ...
    announcement: {
        ...
        howDoISayMode: '"Wie sage ich..."-Modus',
        howDoISayModeDesc: 'Drücken Sie sich natürlich in jeder Sprache aus! Geben Sie einfach ein, was Sie sagen möchten, wählen Sie Ihren Ton, und erhalten Sie sofortige Übersetzungen mit detaillierten Erklärungen, wie sie funktionieren.',
        newSubscription: 'Neues Abonnement',
        newSubscriptionDesc: 'Ein neues "Basis"-Abonnement ist jetzt verfügbar - für nur 4€/Monat erhalten Sie unbegrenzte Satzanalysen und Speicherungen! Schauen Sie es sich auf der Preisseite an.',
        siteRedesignTitle: 'Website-Redesign',
        siteRedesignDesc: 'Hanbok hat ein neues Aussehen, ich hoffe, es gefällt Ihnen!',
        comingSoonLyrics: 'Demnächst: Songtext-Analyse',
        comingSoonLyricsDesc: 'Hanbok wird bald eine Datenbank mit Songtexten + Grammatik- und Vokabelanalyse beherbergen, einschließlich K-Pop, Anime, J-Pop und mehr basierend auf Benutzeranfragen. Bleiben Sie dran!',
