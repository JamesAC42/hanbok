export const en = {
    ...
    announcement: {
        ...
        dashboardTitle: 'New Dashboard Design',
        dashboardDesc: 'We\'ve redesigned the navigation with a beautiful new dashboard that makes it easier than ever to access all your language learning tools in one place.',
        dashboardFeatures: 'Navigate seamlessly between sentence analysis, flashcards, saved content, practice tools, and more with our intuitive sidebar design.',
        tutorTitle: 'AI Tutor Assistant',
        tutorDesc: 'Meet your personal AI language tutor! Ask follow-up questions about any sentence to dive deeper into grammar concepts, cultural context, or vocabulary usage.',
        tutorFeatures: 'Free users can start conversations from sentence analysis pages, while subscribers can create conversations from scratch to ask anything about language learning.',
        tryTutor: 'Try AI Tutor',
        lyricsPageTitle: 'Enhanced Lyrics Page',
        lyricsPageDesc: 'Our lyrics page now includes a favorites system! Save your favorite songs for easy access and build your personal collection of music to learn from.',
        lyricsPageFeatures: 'Browse K-Pop, J-Pop, and Anime songs with detailed breakdowns, suggest new songs, and create your personalized favorites list.',
        viewLyrics: 'View Lyrics Page',
        practiceToolsTitle: 'New Practice Tools',
        practiceToolsDesc: 'Master Korean from the ground up with our new interactive practice pages:',
        koreanTypingTitle: 'Korean Typing Practice',
        koreanTypingDesc: 'Learn to type in Korean with guided lessons and practice exercises to build your Hangeul typing skills.',
        hangeulPracticeTitle: 'Hangeul Learning System',
        hangeulPracticeDesc: 'Master the Korean alphabet with interactive flashcards to quickly drill the characters and their pronunciations.',
        tryPracticeTools: 'Try Practice Tools',
