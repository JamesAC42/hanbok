export const fr = {
    languagePicker: {
        changeNative: 'Changer votre langue maternelle:',
        changeLearning: 'Changer la langue que vous apprenez:',
        tooltip: 'Appuyez ici pour changer de langue'
    },
    languages: {
        korean: 'Coréen',
        english: 'Anglais',
    ...
    about: {
        ...
        twitter: {
            label: 'Twitter',
            text: 'Suivre les mises à jour de développement'
        },
        github: {
            label: 'GitHub',
        ...
        upcomingFeaturesList: [
            'Paquets de vocabulaire personnalisés avec apprentissage par répétition espacée',
            'Télécharger ou coller des captures d\'écran de texte à analyser',
            'Écouter l\'audio des mots individuels',
            'Exercices de grammaire interactifs basés sur les phrases sauvegardées',
            'Fonctionnalités communautaires pour partager et discuter des phrases',
            'Plus de langues !',
            'Plus de fonctionnalités pour les utilisateurs premium !'
        ],
    ...
    feedback: {
        ...
        submitButton: 'Envoyer le Feedback',
        loginPrompt: 'Veuillez vous connecter pour partager votre feedback',
        loading: 'Chargement...',
        emptyState: 'Pas encore de commentaires. Soyez le premier à partager vos pensées !',
        actions: {
            reply: 'Répondre',
            delete: 'Supprimer',
            submit: 'Envoyer',
        ...
        errors: {
            ...
            submitFailed: 'Échec de l\'envoi du feedback. Veuillez réessayer.',
            deleteFailed: 'Échec de la suppression du feedback'
        }
    },
    profile: {
    ...
    login: {
        ...
        features: {
            save: 'Sauvegardez des phrases et des mots pour les revoir plus tard',
            flashcards: 'Bientôt disponible : Cartes mémoire à répétition espacée',
            audio: '15 générations audio gratuites de phrases',
            premium: 'Accès aux futures fonctionnalités premium'
        },
        freeAccount: '✨ Compte Gratuit',
        secureSignIn: '🔐 Connexion Sécurisée avec Google',
    ...
    pricing: {
        ...
        donate: {
            text: '— OU FAITES UN DON POUR SOUTENIR LE SITE ! —'
        }
    },
    success: {
        processing: {
        ...
        completed: {
            title: 'Merci !',
            description: 'Votre paiement a été effectué avec succès et votre compte a été mis à niveau.',
    ...
    home: {
        ...
        tryExample: 'Ou essayez une phrase d\'exemple :',
        stats: {
            sentencesAnalyzed: 'Phrases Analysées',
            wordsLearned: 'Mots en Apprentissage',
    ...
    sentenceForm: {
        ...
        text_disabled_with_image: 'La saisie de texte est désactivée lorsqu\'une image est téléchargée.',
        loading: {
            structure: 'Analyse de la structure de la phrase...',
            grammar: 'Identification des points grammaticaux...',
            pronunciation: 'Vérification des modèles de prononciation...',
            kimchi: 'Dégustation de kimchi...',
            elements: 'Traitement des éléments linguistiques...',
            breakdown: 'Préparation de l\'analyse détaillée...'
        },
        errors: {
            not_korean: 'Veuillez entrer une phrase en caractères coréens (Hangul).',
            invalid_grammar: 'Cette phrase semble contenir des erreurs grammaticales.',
            nonsensical: 'Cette entrée ne forme pas une phrase coréenne sensée.',
    ...
    analysis: {
        ...
        synonyms: 'Synonymes',
        antonyms: 'Antonymes',
        showRelatedWords: 'Afficher les mots associés',
        hideRelatedWords: 'Masquer les mots associés',
        wordInfo: {
            function: 'Fonction',
            notes: 'Notes',
    ...
    limitReached: {
        ...
        plusFeatureTitle: 'Fonctionnalité Plus',
        imageExtractsTitle: 'Limite d\'Extractions d\'Images Atteinte',
        imageExtractsMessage: 'Vous avez utilisé toutes vos extractions d\'images gratuites pour ce mois-ci. Mettez à niveau votre compte pour traiter plus d\'images ou consultez les options de tarification pour en acheter davantage.',
    ...
    loginRequired: {
        ...
        messages: {
            'related-words': {
                main: 'Créez un compte gratuit pour accéder aux relations entre les mots et enrichir votre vocabulaire !',
                sub: 'Rejoignez des milliers d\'apprenants de coréen qui utilisent Hanbok pour améliorer leurs compétences linguistiques.'
            },
            'audio': {
                main: 'Créez un compte gratuit pour générer de l\'audio et entendre la prononciation native !',
                sub: 'Rejoignez des milliers d\'apprenants de coréen qui utilisent Hanbok pour améliorer leur expression orale et leur compréhension.'
            },
            'image-extracts': {
                main: 'Créez un compte gratuit pour extraire du texte à partir d\'images !',
                sub: 'Les comptes gratuits bénéficient de 20 extractions d\'images gratuites pour vous aider à analyser du texte provenant de n\'importe quelle source.'
            },
            'default': {
                main: 'Créez un compte gratuit pour commencer à sauvegarder des {type} et suivre vos progrès !',
                sub: 'Rejoignez des milliers d\'apprenants de coréen qui utilisent Hanbok pour améliorer leurs compétences linguistiques.'
            }
        },
    ...
    audioPlayer: {
        ...
        loginRequired: {
            title: 'Connectez-vous pour générer des échantillons audio et entendre la phrase prononcée par un locuteur natif.',
            cta: 'Créer un compte gratuit',
        },
        noCredits: {
            title: 'Vous n\'avez plus de crédits audio.',
            cta: 'Obtenir Plus',
        }
    },
    saves: {
        ...
        words: 'Mots',
        loading: 'Chargement...',
        noSentences: 'Aucune phrase sauvegardée trouvée.',
        noWords: 'Aucun mot sauvegardé trouvé.',
        clickBookmark: 'Cliquez sur l\'icône',
        clickAdd: 'Cliquez sur l\'icône',
        ...
        flashcardsComingSoon: 'Cartes mémoire bientôt disponibles !',
        fetchError: 'Erreur lors du chargement des {type} sauvegardés.'
    },
    announcement: {
        new: 'Nouveau',
        newFeatures: 'Nouvelles Fonctionnalités Disponibles !',
        dashboardTitle: 'Nouveau Design de Tableau de Bord',
        dashboardDesc: 'Nous avons repensé la navigation avec un magnifique nouveau tableau de bord qui facilite plus que jamais l\'accès à tous vos outils d\'apprentissage linguistique en un seul endroit.',
        dashboardFeatures: 'Naviguez en toute transparence entre l\'analyse de phrases, les cartes mémoire, le contenu sauvegardé, les outils de pratique et plus encore avec notre conception intuitive de barre latérale.',
        tutorTitle: 'Assistant Tuteur IA',
        tutorDesc: 'Rencontrez votre tuteur personnel de langues IA ! Posez des questions de suivi sur n\'importe quelle phrase pour approfondir les concepts grammaticaux, le contexte culturel ou l\'usage du vocabulaire.',
        tutorFeatures: 'Les utilisateurs gratuits peuvent démarrer des conversations depuis les pages d\'analyse de phrases, tandis que les abonnés peuvent créer des conversations à partir de zéro pour poser n\'importe quelle question sur l\'apprentissage des langues.',
        tryTutor: 'Essayer le Tuteur IA',
        lyricsPageTitle: 'Page de Paroles Améliorée',
        lyricsPageDesc: 'Notre page de paroles inclut maintenant un système de favoris ! Sauvegardez vos chansons préférées pour un accès facile et créez votre collection personnelle de musique pour apprendre.',
        lyricsPageFeatures: 'Parcourez les chansons K-Pop, J-Pop et Anime avec des analyses détaillées, suggérez de nouvelles chansons et créez votre liste de favoris personnalisée.',
        viewLyrics: 'Voir la Page de Paroles',
        practiceToolsTitle: 'Nouveaux Outils de Pratique',
        practiceToolsDesc: 'Maîtrisez le coréen depuis le début avec nos nouvelles pages de pratique interactives :',
        koreanTypingTitle: 'Pratique de Frappe Coréenne',
        koreanTypingDesc: 'Apprenez à taper en coréen avec des leçons guidées et des exercices de pratique pour développer vos compétences de frappe Hangeul.',
        hangeulPracticeTitle: 'Système d\'Apprentissage Hangeul',
        hangeulPracticeDesc: 'Maîtrisez l\'alphabet coréen avec des cartes mémoire interactives pour pratiquer rapidement les caractères et leurs prononciations.',
        tryPracticeTools: 'Essayer les Outils de Pratique',
        newSubscription: 'Nouveau Plan d\'Abonnement',
        newSubscriptionDesc: 'Un nouvel abonnement de niveau "Basique" est maintenant disponible - pour seulement 4$/mois, vous obtenez des analyses et sauvegardes de phrases illimitées ! Consultez-le sur la page de tarification.',
        communityTitle: 'Rejoignez Notre Communauté Grandissante',
        communityDesc: 'Si vous appréciez utiliser Hanbok, nous aimerions que vous rejoigniez notre communauté ! Partagez votre expérience avec des amis et aidez-nous à grandir.',
        discordInvite: 'Rejoignez notre communauté Discord pour les mises à jour, donner des commentaires et vous connecter avec d\'autres apprenants !',
    ...
    bookmarks: {
        ...
        title: 'Favoris',
        libraryBlurb: 'Gardez vos analyses préférées et revenez-y quand vous voulez.',
        searchPlaceholder: 'Rechercher des favoris',
        showAll: 'Tous les éléments',
        showSentences: 'Phrases',
        showExtended: 'Textes étendus',
        extendedBadge: 'Texte étendu',
        extendedNoSummary: 'Ouvrez pour voir l’analyse complète',
        untitledExtendedText: 'Texte étendu sans titre',
    ...
    history: {
        ...
        title: 'Historique',
        libraryBlurb: 'Revisitez chaque analyse et suivez tout ce que vous avez exploré.',
    ...
    tutor: {
        ...
        limits: {
            monthlyConversations: 'Conversations mensuelles',
            freeUserRestriction: 'Les utilisateurs gratuits peuvent uniquement démarrer des conversations à partir des pages d\'analyse de phrase. Passez à la version supérieure pour démarrer des conversations de zéro.',
            monthlyLimitReached: 'Vous avez atteint la limite mensuelle de conversations.',
            freeUserNotice: 'Les utilisateurs gratuits ne peuvent démarrer des conversations qu\'à partir de phrases.',
            monthlyLimitReachedWarning: 'Limite mensuelle atteinte. Passez à la version supérieure pour plus de conversations.',
            messageLimitReached: 'Vous avez atteint la limite de messages ({limit}) pour cette conversation. Démarrez une nouvelle conversation ou passez à la version supérieure.'
        }
    },
    lessons: {
