export const fr = {
    ...
    announcement: {
        ...
        howDoISayMode: 'Mode "Comment dire..."',
        howDoISayModeDesc: 'Exprimez-vous naturellement dans n\'importe quelle langue ! Tapez simplement ce que vous voulez dire, choisissez votre ton, et obtenez des traductions instantanées avec des explications détaillées de leur fonctionnement.',
        newSubscription: 'Nouveau Plan d\'Abonnement',
        newSubscriptionDesc: 'Un nouvel abonnement "Basique" est maintenant disponible - pour seulement 4€/mois, vous obtenez des analyses de phrases et des sauvegardes illimitées ! Consultez la page des tarifs.',
        siteRedesignTitle: 'Redesign du Site',
        siteRedesignDesc: 'Hanbok a un nouveau look, j\'espère que vous l\'aimez !',
        comingSoonLyrics: 'Bientôt : Analyse de Paroles de Chansons',
        comingSoonLyricsDesc: 'Hanbok abritera bientôt une base de données de paroles de chansons + analyse grammaticale et vocabulaire, y compris K-Pop, Anime, J-Pop et plus encore selon les demandes des utilisateurs. Restez à l\'écoute !',
