export const ko = {
    ...
    about: {
        title: '소개',
        whatIsHanbok: '한복이란?',
        description: '한복은 한국어 학습자가 한국어 문장을 이해하고 마스터하는 데 도움을 주는 종합적인 도구입니다. 한복은 한국어 문장을 구성 요소로 분석하여 문법 패턴, 어휘, 사용법에 대한 상세한 분석을 제공합니다.',
        screenshotAlt: '스크린샷',
        exampleAnalysis: '문장 분석 예시',
        registeredFeatures: '등록된 계정은 남성과 여성 원어민의 오디오 예제에 접근할 수 있어 발음을 완벽하게 하고 자연스러운 말하기 패턴을 이해하는 데 도움이 됩니다. 또한 한국어 사용에 대한 맥락과 더 깊은 이해를 위한 문화적 설명도 제공합니다.',
        culturalNotes: '문화적 설명과 상황별 변형',
        benefitsDescription: '초보자든 고급 학습자든, 우리 도구는 한국어 문법, 어휘, 문화적 맥락의 뉘앙스를 한 곳에서 이해하는 데 도움을 줍니다.',
