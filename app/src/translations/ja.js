export const ja = {
    ...
    about: {
        ...
        description: 'hanbokは韓国語学習者が韓国語の文章を理解し習得するための総合的なツールです。文章を構成要素に分解し、文法パターン、語彙、使用法の詳細な分析を提供します。',
        screenshotAlt: 'スクリーンショット',
        exampleAnalysis: '文章分析の例',
        registeredFeatures: '登録アカウントでは、男性と女性のネイティブスピーカーの音声例にアクセスでき、発音の完璧な習得と自然な話し方のパターンの理解に役立ちます。また、韓国語の使用に関する文脈とより深い理解のための文化的な注釈も提供しています。',
        culturalNotes: '文化的な注釈と状況に応じたバリエーション',
        benefitsDescription: '初心者でも上級学習者でも、韓国語の文法、語彙、文化的な文脈のニュアンスを一箇所で理解するのに役立ちます。',
