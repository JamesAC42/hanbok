export const ja = {
    languagePicker: {
        changeNative: 'ネイティブ言語を変更:',
        changeLearning: '学習言語を変更:',
        tooltip: '言語を変更するにはここをタップ'
    },
    languages: {
        korean: '韓国語',
        english: '英語',
    ...
    about: {
        ...
        exampleAnalysis: '文章分析の例',
        registeredFeatures: '登録アカウントでは、男性と女性のネイティブスピーカーの音声例にアクセスでき、発音の完璧な習得と自然な話し方のパターンの理解に役立ちます。また、言語使用に関する文脈とより深い理解のための文化的な注釈も提供しています。',
        culturalNotes: '文化的な注釈と状況に応じたバリエーション',
        benefitsDescription: '初心者でも上級学習者でも、文法、語彙、文化的な文脈のニュアンスを一箇所で理解するのに役立ちます。',
        saveFeature: '興味深い文章や難しい文章を後で参照できるように保存できます。近日中に、遭遇した単語や文法パターンから個人用の学習デッキを作成し、間隔反復学習を通じて効率的に学習できるようになります。',
        upcomingFeatures: '今後の機能',
        updateHistory: '更新履歴',
        contactLinks: '連絡先とリンク',
        twitter: {
            label: 'Twitter',
            text: '開発アップデートをフォロー'
        },
        ...
        upcomingFeaturesList: [
            '間隔反復学習による個人化された語彙デッキ',
            'テキスト分析のためのスクリーンショットのアップロードまたは貼り付け',
            '個別の単語の音声再生',
            '保存した文章に基づくインタラクティブな文法練習',
    ...
    feedback: {
        ...
        loginPrompt: 'フィードバックを共有するにはログインしてください',
        loading: '読み込み中...',
        emptyState: 'まだコメントはありません。最初の意見を共有しましょう！',
        actions: {
            reply: '返信',
            delete: '削除',
            submit: '送信',
        ...
        errors: {
            ...
            deleteFailed: 'フィードバックの削除に失敗しました'
        }
    },
    profile: {
    ...
    login: {
        ...
        features: {
            save: '文章と単語を後で復習するために保存',
            flashcards: '近日公開：間隔反復フラッシュカード',
            audio: '15回分の無料音声生成',
            premium: '今後追加されるプレミアム機能へのアクセス'
        },
        freeAccount: '✨ 無料アカウント',
        secureSignIn: '🔐 Googleで安全にログイン',
    ...
    success: {
        processing: {
            title: '決済処理中...',
            description: '決済の確認をお待ちください。'
        },
        completed: {
            title: 'ありがとうございます！',
            description: '決済が完了し、アカウントがアップグレードされました。',
    ...
    home: {
        ...
        tryExample: 'または例文を試してみましょう：',
        stats: {
            sentencesAnalyzed: '分析された文章',
            wordsLearned: '学習中の単語',
    ...
    sentenceForm: {
        ...
        loading: {
            structure: '文章構造を分析中...',
            grammar: '文法ポイントを特定中...',
            pronunciation: '発音パターンを確認中...',
            kimchi: 'キムチを食べています...',
            elements: '言語要素を処理中...',
            breakdown: '詳細な分析を準備中...'
        },
        errors: {
            not_korean: 'ハングル（韓国語文字）で文章を入力してください。',
            invalid_grammar: 'この文章には文法的な誤りがあるようです。',
    ...
    analysis: {
        ...
        synonyms: '同義語',
        antonyms: '反意語',
        showRelatedWords: '関連語を表示',
        hideRelatedWords: '関連語を非表示',
        wordInfo: {
            function: '機能',
            notes: '注釈',
            role: 'この単語の文中での役割は',
    ...
    loginRequired: {
        ...
        messages: {
            'related-words': {
                main: '無料アカウントを作成して、単語の関連性を確認し、語彙力を向上させましょう！',
                sub: 'hanbokを使って言語力を向上させている数千人の学習者に参加しましょう。'
            },
            'audio': {
    ...
    audioPlayer: {
        ...
        loginRequired: {
            title: 'ネイティブスピーカーによる音声サンプルを聞くにはサインインしてください。',
            cta: '無料アカウントを作成',
        },
        noCredits: {
            title: '音声生成クレジットがありません。',
            cta: 'もっと取得',
        }
    },
    saves: {
        ...
        words: '単語',
        loading: '読み込み中...',
        noSentences: '保存された文章はありません。',
        noWords: '保存された単語はありません。',
    ...
    announcement: {
        ...
        dashboardTitle: '新しいダッシュボードデザイン',
        dashboardDesc: 'すべての言語学習ツールに一箇所でアクセスしやすくする美しい新しいダッシュボードでナビゲーションを再設計しました。',
        dashboardFeatures: '直感的なサイドバーデザインで文分析、フラッシュカード、保存されたコンテンツ、練習ツールなどをシームレスに移動できます。',
        tutorTitle: 'AIチューターアシスタント',
        tutorDesc: 'あなた専用のAI言語チューターと出会いましょう！文に関するフォローアップ質問をして、文法概念、文化的文脈、語彙使用法をより深く理解しましょう。',
        tutorFeatures: '無料ユーザーは文分析ページから会話を始めることができ、購読者は言語学習について何でも質問する会話を最初から作成できます。',
        tryTutor: 'AIチューターを試す',
        lyricsPageTitle: '歌詞ページの強化',
        lyricsPageDesc: '歌詞ページにお気に入りシステムが追加されました！お気に入りの曲を簡単にアクセスできるように保存し、学習のための個人音楽コレクションを構築しましょう。',
        lyricsPageFeatures: '詳細な分析とともにK-POP、J-POP、アニメソングを閲覧し、新しい曲を提案し、個人化されたお気に入りリストを作成しましょう。',
        viewLyrics: '歌詞ページを見る',
        practiceToolsTitle: '新しい練習ツール',
        practiceToolsDesc: '新しいインタラクティブ練習ページで韓国語を基礎からマスターしましょう：',
        koreanTypingTitle: '韓国語タイピング練習',
        koreanTypingDesc: 'ガイド付きレッスンと練習問題で韓国語タイピングを学び、ハングルタイピングスキルを身につけましょう。',
        hangeulPracticeTitle: 'ハングル学習システム',
        hangeulPracticeDesc: 'インタラクティブフラッシュカードで韓国語アルファベットをマスターし、文字と発音を素早く覚えましょう。',
        tryPracticeTools: '練習ツールを試す',
        newSubscription: '新サブスクリプションプラン',
        newSubscriptionDesc: '新しい「ベーシック」ティア購読が利用可能になりました - 月額$4で無制限の文分析と保存が可能です！料金ページをご確認ください。',
        communityTitle: '成長するコミュニティに参加しましょう',
        communityDesc: 'Hanbokを楽しんでいるなら、ぜひ私たちのコミュニティに参加してください！友達と経験を共有し、成長を助けてください。',
        discordInvite: '更新情報、フィードバック提供、他の学習者との交流のためにDiscordコミュニティに参加しましょう！',
