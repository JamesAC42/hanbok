export const zh = {
    ...
    about: {
        ...
        description: 'hanbok是一个综合工具，旨在帮助韩语学习者理解和掌握韩语句子。hanbok将韩语句子分解为组成部分，提供语法模式、词汇和用法的详细分析。',
        screenshotAlt: '截图',
        exampleAnalysis: '句子分析示例',
        registeredFeatures: '注册账户可以访问男性和女性母语者的音频示例，帮助您完善发音并理解自然的语言模式。我们还提供文化注释，帮助您理解韩语使用的上下文和更深层含义。',
        culturalNotes: '文化注释和不同情境的变体',
        benefitsDescription: '无论您是初学者还是高级学习者，我们的工具都能帮助您在一个地方理解韩语语法、词汇和文化背景的细微差别。',
